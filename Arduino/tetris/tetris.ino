...
static uint8_t masks[NUM_MASKS][MASK_WIDTH] = {
                              ...
                              {0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00}, // Rectangle [1]
                              {0x00, 0x00, 0x03, 0x03, 0xFF, 0xFF, 0x00, 0x00}, // Left-facing L [2]
                              {0x00, 0x00, 0xC0, 0xC0, 0xFF, 0xFF, 0x00, 0x00}, // Right-facing L [3]
                              {0x00, 0x00, 0x18, 0x18, 0x7E, 0x7E, 0x00, 0x00}, // T [4]
